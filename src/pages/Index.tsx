...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-hero">{/* Community Leaderboards */}  
      {/* Navigation */}
      <nav className="absolute top-0 left-0 right-0 z-50 bg-black/40 backdrop-blur-md lg:bg-transparent lg:backdrop-blur-none p-6">
      ...
      {/* Hero Section */}
      <section className="relative px-6 pt-40 pb-12 md:pt-48 md:pb-12 lg:py-20 overflow-hidden">
